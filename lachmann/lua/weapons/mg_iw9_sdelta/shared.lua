...
if CLIENT then
    killicon.Add( "mg_iw9_sdelta", "VGUI/entities/mg_iw9_sdelta", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_cac_weapon_sm_iw9_sdelta")
end
...
SWEP.PrintName = "Lachmann Shroud"
SWEP.Category = "Modern Warfare"
SWEP.SubCategory = "Submachine Guns"
SWEP.Spawnable = true
SWEP.VModel = Model("models/easy/mw/weapons/vm_iw9_sdelta.mdl")
...
SWEP.Primary.RPM = 714  
SWEP.CanChamberRound = false  
SWEP.FreezeInspectDelta = 0.25
SWEP.Purpose = "This integrally suppressed, burst-fire submachine gun brings power and stealth to its class with Subsonic Ammo and suppressed-only barrels."
